...
def publishDVLdata():
    ...
    if theData["id"] == 8219:
        ...
        BottomSpeedOfSoundData = theData["frames"][2]["inputs"][0]["lines"][0]["data"][
            0
        ]
        ...
        velocity_covariance = [
            ...
            unknown,
            unknown,
            BottomXyzFom2Data * BottomXyzFom2Data,
            unknown,
            unknown,
            unknown,
            BottomXyzFomZbest * BottomXyzFomZbest,
        ]
        ...
        beam1.pose.pose.orientation.x = (
            0.211  # Estimating values here. 25 degree tilt and 4 cm from origo
        )
        ...
        beam4.pose.pose.orientation.x = (
            0  # Estimating values here. 25 degree tilt and 4 cm from origo
        )
        ...
        thePressure.fluid_pressure = (
            BottomPressureData * 10000
        )  # Convert dbar to Pascal
        thePressure.variance = (
            30 * 30
...
if __name__ == "__main__":
	...
	websocket_address = rospy.get_param(
		"/dvl/websocket_address", "ws://192.168.0.96:10100"
	)
	...
	rospy.loginfo("Connecting to DVL1000 via websocket...")
	result = ws.recv()
	rospy.loginfo("websocket status: '%s'" % result)
