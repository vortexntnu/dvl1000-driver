...
ws = create_connection("ws://10.42.0.96:10100",
                       subprotocols=["data-transfer-nortek"])
...
def publishDVLdata():
    ...
    if theData["id"] == 8219:
        ...
        # Doing covariances
        velocity_covariance = [BottomXyzFom1Data * BottomXyzFom1Data, unknown, unknown, unknown,
                               BottomXyzFom2Data * BottomXyzFom2Data, unknown, unknown, unknown, BottomXyzFomZbest * BottomXyzFomZbest]

        # Feeding message
        theDVL.velocity_covariance = velocity_covariance
        theDVL.altitude = ((BottomBeamDist1Data + BottomBeamDist2Data +
                            BottomBeamDist3Data + BottomBeamDist4Data) / 4)
        ...
        # Estimating values here. 25 degree tilt and 4 cm from origo
        beam1.pose.pose.orientation.x = 0.211
        ...
        # Estimating values here. 25 degree tilt and 4 cm from origo
        beam2.pose.pose.orientation.x = -0.211
        ...
        # Estimating values here. 25 degree tilt and 4 cm from origo
        beam3.pose.pose.orientation.x = -0.299
        ...
        # Estimating values here. 25 degree tilt and 4 cm from origo
        beam4.pose.pose.orientation.x = 0
     ...
     # Twist topic
        theTwist.header.stamp = rospy.Time.now()
        theTwist.header.frame_id = "twist_link"
        ...
        if (BottomXyzFom1Data != 10) and (BottomXyzFom2Data != 10) and (BottomXyzFomZbest != 10):
            theTwist.twist.covariance = [BottomXyzFom1Data * BottomXyzFom1Data, unknown, unknown, unknown, unknown, unknown, unknown, BottomXyzFom2Data * BottomXyzFom2Data, unknown, unknown, unknown, unknown, unknown, unknown,
                                         BottomXyzFomZbest * BottomXyzFomZbest, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown]
